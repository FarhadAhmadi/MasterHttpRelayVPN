# MasterHttpRelayVPN v1 Docs (English)

Welcome to the structured v1 documentation set.

## Contents

- [1. Overview](01-overview.md)
- [2. Installation & Setup](02-installation-and-setup.md)
- [3. Telegram Desktop Guide](03-telegram-desktop-guide.md)
- [4. Features](04-features.md)
- [5. Commands & CLI](05-commands-and-cli.md)
- [6. Configuration Reference](06-configuration-reference.md)
- [7. Dashboard, Admin API, and Metrics](07-dashboard-api-metrics.md)
